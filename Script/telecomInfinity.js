...
if(data.items[1].items[2].nameType == 131100){
   voiceAmount = data.items[1].items[2].ratableAmount
   voiceBalance = data.items[1].items[2].balanceAmount
   voiceUsage = data.items[1].items[2].usageAmount
  }
if(data.items[1].items[1].nameType == 401100){
   msgUsage = data.items[1].items[1].usageAmount
   msgAmount = data.items[1].items[1].ratableAmount
   msgBalance = data.items[1].items[1].balanceAmount
